...
\centering
\small
\caption{Cross-host evidence for model-agnostic safe refinement and exact strict fallback.}
\label{tab:cross_host_model_agnostic}
\begin{tabular}{llllllllll}
\toprule
dataset & modality & host & stage & host\_dice & best\_fixed\_gain & fixed\_harm & best\_practical\_gain & best\_practical\_harm & strict\_exact\_fallback \\
\midrule
